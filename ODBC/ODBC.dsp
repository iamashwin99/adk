...
# ADD LINK32 /nologo /base:"0x69E00000" /subsystem:windows /dll /debug /machine:I386
# Begin Special Build Tool
OutDir=.\Release
SOURCE="$(InputPath)"
PostBuild_Cmds=copy  $(OutDir)\ODBC.dll  E:\Work\Broker\Plugins 	copy  $(OutDir)\ODBC.dll  $(OutDir)\ODBCA.dll 	REBASE  -b  0x68F00000  $(Outdir)\ODBCA.DLL 	copy  $(OutDir)\ODBCA.dll  E:\Work\Broker\Plugins\ 
...
OutDir=.\Debug
SOURCE="$(InputPath)"
PostBuild_Cmds=copy $(OutDir)\ODBC.dll E:\Work\Broker\Plugins	copy $(OutDir)\ODBC.dll E:\Work\Broker\Plugins\ODBCA.dll
# End Special Build Tool
